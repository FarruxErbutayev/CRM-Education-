            ...
            <form @submit.prevent="submit({ firstname, lastname, phone, description })">
                <div
                    ...
                    <div class="flex flex-col">
                        ...
                        <h5 class="text-2xl text-blue-300  font-bold ">Biz siz bilan tez orada bog'lanamiz</h5>
                    ...
                    <div class="my-4">
                        <textarea required v-model="description" placeholder="Xabar"
                ...
                <div class="flex flex-col text-white">
                    <div class="flex w-2/3 my-4 lg:w-1/2">
                        ...
                        <div>
                            ...
                            <p class="text-gray-200" style="white-space: nowrap;">Intellect Education Pro</p>
                        </div>
                    </div>
                    <div class="flex w-2/3 my-4 lg:w-1/2">
                        ...
                        <div>
                            ...
                            <p class="text-gray-200" style="white-space: nowrap;"><Tel:>97141-06-91 91941-50-77</Tel:>
                          </p>
                        </div>
                    </div>
                    <div class="flex w-2/3 my-4 lg:w-1/2">
                        ...
                        <div>
                            ...
                            <p class="text-gray-200" style="white-space: nowrap;">Email:azizbektayloq@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
